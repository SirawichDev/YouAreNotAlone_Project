...
public class ShakeEventManager implements SensorEventListener {
    ...
    private static final int MOV_COUNTS = 6;
    private static final int MOV_THRESHOLD = 10;
    private static final float ALPHA = 0.4F;
    private static final int SHAKE_WINDOW_TIME_INTERVAL = 10000; // milliseconds
    ...
    public ShakeEventManager(GMapsShareLocationActivity gMapsShareLocationActivity) {
    }
    ...
    public void register() {
        sManager.registerListener(this, s, SensorManager.SENSOR_STATUS_ACCURACY_LOW);
    }
